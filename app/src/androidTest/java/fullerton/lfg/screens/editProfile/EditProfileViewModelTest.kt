...
/**
 * These tests should work provided that the androidx.test import works
 * I tried multiple ways including rebuilding, remaking the project,
 * Changing the imports in build.gradle, but nothing worked
 * Since database tests are not required, I will leave them commented out for running purposes
 */
